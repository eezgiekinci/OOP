...
public class Doctoral extends Student<GraduateCourse> {
	
	//There are three category of student class. One of them is Doctora Student:
	//super() refers variables which are used by parent class:
	
	
	public Doctoral(int id, String fullName, int registeredYear) {
		super(id, fullName, registeredYear);
		super.MINIMUM_COURSE_COUNT = 8;
		super.MINIMUM_ELIGIBLE_LEVEL = 3.0;
	}
	...
	public void Graduate() {
		if(super.getCourses().size() < MINIMUM_COURSE_COUNT) {
			System.out.println("unable to graduate Doctoral student!");
		}
	}
}
